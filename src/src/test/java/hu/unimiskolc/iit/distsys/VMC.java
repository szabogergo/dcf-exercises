...
public class VMC implements VMCreationApproaches{
	...
	public void twoPhaseVMCreation() throws Exception{
		...
		VirtualAppliance va1 = new VirtualAppliance("VirtualAppliance1", 50.0, 0);
		VirtualAppliance va2 = new VirtualAppliance("VirtualAppliance2", 50.0, 0);
		
		VirtualMachine vm1 = new VirtualMachine(va1);
		VirtualMachine vm2 = new VirtualMachine(va2);
		
		ResourceConstraints rc1 = new ConstantConstraints(0.25, 10.0, 12800);
		ResourceConstraints rc2 = new ConstantConstraints(0.25, 10.0, 12800);
		
		ResourceAllocation ra1 = pm1.allocateResources(rc1, false, 0);
		ResourceAllocation ra2 = pm1.allocateResources(rc2, false, 0);
